...
const (
	TypeMsgCreateDepositEarned = "create_deposit_earned"
	TypeMsgUpdateDepositEarned = "update_deposit_earned"
	TypeMsgDeleteDepositEarned = "delete_deposit_earned"
)
...
func (msg *MsgCreateDepositEarned) Type() string {
	return TypeMsgCreateDepositEarned
}
...
func (msg *MsgUpdateDepositEarned) Type() string {
	return TypeMsgUpdateDepositEarned
}
...
var _ sdk.Msg = &MsgDeleteDepositEarned{}
...
func (msg *MsgDeleteDepositEarned) Type() string {
	return TypeMsgDeleteDepositEarned
}
