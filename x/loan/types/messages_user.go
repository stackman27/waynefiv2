...
func NewMsgCreateUser(creator string, collateral []bool, deposit []*Deposit, borrow []*Borrow, assetBalances []int32, depositEarneds []*DepositEarned, borrowAccureds []*BorrowAccured, txHistories []*TxHistory) *MsgCreateUser {
...
func NewMsgUpdateUser(creator string, id uint64, collateral []bool, deposit []*Deposit, borrow []*Borrow, assetBalances []int32, depositEarneds []*DepositEarned, borrowAccureds []*BorrowAccured, txHistories []*TxHistory) *MsgUpdateUser {
