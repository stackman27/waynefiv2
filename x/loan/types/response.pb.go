...
func (*LoadPoolResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_12a73485e3bc6b75, []int{0}
}
...
type LoadUserResponse struct {
	...
	BorrowAccured    int32  `protobuf:"varint,9,opt,name=BorrowAccured,proto3" json:"BorrowAccured,omitempty"`
...
func (*LoadUserResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_12a73485e3bc6b75, []int{1}
}
...
func (m *LoadUserResponse) GetBorrowAccured() int32 {
	if m != nil {
...
func (*UserAssetBalances) Descriptor() ([]byte, []int) {
	return fileDescriptor_12a73485e3bc6b75, []int{2}
}
...
func init() {
	proto.RegisterType((*LoadPoolResponse)(nil), "loan.loan.LoadPoolResponse")
	proto.RegisterType((*LoadUserResponse)(nil), "loan.loan.LoadUserResponse")
	proto.RegisterType((*UserAssetBalances)(nil), "loan.loan.UserAssetBalances")
}

func init() { proto.RegisterFile("loan/response.proto", fileDescriptor_12a73485e3bc6b75) }

var fileDescriptor_12a73485e3bc6b75 = []byte{
	// 434 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *LoadUserResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BorrowAccured != 0 {
		i = encodeVarintResponse(dAtA, i, uint64(m.BorrowAccured))
		i--
		dAtA[i] = 0x48
	}
...
func (m *LoadUserResponse) Size() (n int) {
	...
	if m.BorrowAccured != 0 {
		n += 1 + sovResponse(uint64(m.BorrowAccured))
	}
	l = len(m.Asset)
	if l > 0 {
		n += 1 + l + sovResponse(uint64(l))
	...
	for iNdEx < l {
		...
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BorrowAccured |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
